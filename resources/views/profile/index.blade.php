        ...
        <div class="col-12 col-md-6 col-lg-5">
            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <div class="p-3 text-white text-center" style="background-color: #39A900;">
                    <span class="badge bg-white text-success fw-bold px-3 py-1 rounded-pill mb-1"
                ...
                <div class="card-body p-4 text-center bg-white">
                    ...
                    <div class="mb-3 position-relative d-inline-block">
                        <div class="rounded-circle bg-light border border-3 border-success
                    ...
                    <div class="p-3 bg-light rounded-3 d-inline-block border mb-2 shadow-sm">
                        ...
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ auth()->user()->id }}"
                ...
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-3">
                            Este panel simula la pantalla del escáner en la entrada
                            de los laboratorios o aulas de formación.
                        </p>
                    ...
                    <button class="btn btn-outline-dark btn-sm w-100 rounded-pill"
                        onclick="alert('Simulación: Escaneando nuevo código QR...')">
