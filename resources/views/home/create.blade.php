...
<div id="announcementContainer" class="position-relative mb-5" style="z-index: 100;">
    <div id="announcementCarousel" class="carousel slide shadow-lg text-white" data-bs-ride="carousel" style="border-radius: 16px; background: linear-gradient(135deg, #00324d 0%, #001e30 100%); border: 1px solid rgba(255, 255, 255, 0.1); overflow: hidden;">
        ...
        <!-- Indicadores (Puntos de navegación dinámicos) -->
        <div class="carousel-indicators mb-2">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item {{ $loop->first ? 'active' : '' }}" data-bs-interval="6000">
                <div class="p-4 p-md-5 d-flex align-items-center justify-content-between flex-wrap gap-4">
                    <div style="max-width: 650px;">
                        <span class="badge {{ $announcement->badge_class ?? 'bg-success' }} px-3 py-2 rounded-pill fw-bold mb-2">
                            {{ $announcement->badge_text }}
                        </span>
                        <h3 class="fw-bold mb-2">{{ $announcement->title }}</h3>
                        <p class="mb-0 text-white-50">{{ $announcement->description }}</p>
                    </div>

                    @if($announcement->button_text && $announcement->button_url)
                    <div>
                        <a href="{{ $announcement->button_url }}" class="btn btn-outline-light rounded-pill px-4 py-2 hover-scale">
            ...
            @empty
            <!-- Anuncio por defecto si la base de datos está vacía -->
            <div class="carousel-item active" data-bs-interval="6000">
                <div class="p-4 p-md-5 text-center">
                    <h3 class="fw-bold mb-2">Bienvenido al Sistema</h3>
                    <p class="mb-0 text-white-50">No hay anuncios publicados en este momento.</p>
                </div>
            </div>
            @endforelse
        </div>
    ...
    <style>
        ...
        .sena-bg-green {
            background-color: var(--sena-gray) !important;
        }
            ...
            <div class="card-body p-4 p-md-5 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                    ...
                    <h1 class="display-6 fw-bold mb-2">
                        ¡Bienvenido, {{ auth()->user()->name ?? 'a AdminSena' }}!
                    </h1>
