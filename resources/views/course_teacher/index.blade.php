                        ...
                        <tr>
                            ...
                            <td class="pe-4 text-center">
                                <div class="d-flex gap-2 justify-content-center align-items-center">
                                    ...
                                    <!-- Botón Eliminar -->
                                    <form action="{{ route('course_teacher.destroy', $assignment->id) }}" method="POST" class="d-inline m-0" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta asignación?');">
                                        @csrf
                                        @method('DELETE')
